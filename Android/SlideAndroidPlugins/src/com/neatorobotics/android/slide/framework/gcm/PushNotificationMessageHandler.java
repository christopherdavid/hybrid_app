...
public class PushNotificationMessageHandler {
    ...
    static {
        sNotificationResourceIdMap.put(RobotCommandPacketConstants.NOTIFICATION_ID_ROBOT_STUCK,
                R.string.notification_text_robot_stuck);
        sNotificationResourceIdMap.put(RobotCommandPacketConstants.NOTIFICATION_ID_DIRT_BIN_FULL,
                R.string.notification_text_dirt_bag_full);
        sNotificationResourceIdMap.put(RobotCommandPacketConstants.NOTIFICATION_ID_CLEANING_DONE,
                R.string.notification_text_cleaning_done);
        sNotificationResourceIdMap.put(RobotCommandPacketConstants.NOTIFICATION_ID_GENERIC,
                R.string.notification_text_generic_message);
    }
    ...
    private void sendBackgroundNotification(Context context, Bundle bundle) {
        ...
        builder.setSmallIcon(R.drawable.notification_icon).setContentTitle(notificationTitle).setContentText(message)
                .setTicker(message).setContentIntent(pendingIntent).setAutoCancel(true);
