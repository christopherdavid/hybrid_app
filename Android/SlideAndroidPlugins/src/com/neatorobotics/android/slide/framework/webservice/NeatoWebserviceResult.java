...
public abstract class NeatoWebserviceResult {
    ...
    public int status = -1; // 0 is returned as success from the webservice so
    ...
    public final boolean isServerError() {
        return (mResponseStatus == NeatoWebConstants.RESPONSE_SERVER_ERROR)
                || (mResponseStatus == NeatoWebConstants.RESPONSE_SERVER_ERROR_REASON_UNKNOWN);
    }
