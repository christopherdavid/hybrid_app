...
public class RequestPacket implements Parcelable {
    ...
    public void writeToParcel(Parcel out) {
        ...
        out.writeByte((byte) (responseNeeded ? 1 : 0)); // if responseNeeded ==
                                                        // true, byte == 1
    ...
    public static RequestPacket readFromParcel(Parcel in) {
        ...
        boolean responseNeeded = in.readByte() == 1; // if responseNeeded ==
                                                     // true, byte == 1
    ...
    public static RequestPacket createRequestPacket(Context context, int commandId,
