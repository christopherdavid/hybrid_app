...
public class RobotCommandPacketUtils {
	...
	// One step method to create RobotCommandPacket XML.
	public static String getRobotCommandPacketXml(Context context, int commandId, HashMap<String, String> commandParams, int distributionMode) {
	...
	public static RobotCommandPacket getRobotCommandPacket(Context context, int commandId, HashMap<String, String> commandParams, int distributionMode) {
		RequestPacket request = RequestPacket.createRequestPacket(context, commandId, commandParams);
		RobotRequests requests = new RobotRequests();
		requests.addCommand(request);
		request.setDistributionMode(distributionMode);
