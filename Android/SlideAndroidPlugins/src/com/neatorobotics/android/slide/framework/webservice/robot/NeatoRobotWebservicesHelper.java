...
public class NeatoRobotWebservicesHelper {
    ...
    public static RobotDetailResult getRobotDetail(Context context, String serialNumber)
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, GetRobotDetails.METHOD_NAME,
                robotGetDetailParams);
    ...
    public static RobotClearDataResult clearRobotDataRequest(Context context, String email, String robotId)
        ...
        String clearRobotDataResponse = MobileWebServiceClient.executeHttpPost(context, ClearRobotData.METHOD_NAME,
                clearRobotDataReqParams);
