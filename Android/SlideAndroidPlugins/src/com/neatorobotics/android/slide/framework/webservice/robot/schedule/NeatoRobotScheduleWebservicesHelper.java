...
public class NeatoRobotScheduleWebservicesHelper {
    ...
    public static AddNeatoRobotScheduleDataResult addNeatoRobotScheduleDataRequest(Context context,
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, PostNeatoRobotScheduleData.METHOD_NAME,
                postNeatoRobotScheduleDataReqParams);
        return AppUtils.checkResponseResult(response, AddNeatoRobotScheduleDataResult.class);
    }

    public static UpdateNeatoRobotScheduleResult updateNeatoRobotScheduleDataRequest(Context context,
            String robot_schedule_id, String schedule_type, String xml_data, String xml_data_version)
            throws UserUnauthorizedException, NeatoServerException, IOException {

        Map<String, String> updateNeatoRobotScheduleDataReqParams = new HashMap<String, String>();
        updateNeatoRobotScheduleDataReqParams.put(UpdateNeatoRobotScheduleData.Attribute.ROBOT_SCHEDULE_ID,
                robot_schedule_id);
        updateNeatoRobotScheduleDataReqParams.put(UpdateNeatoRobotScheduleData.Attribute.SCHEDULE_TYPE, schedule_type);
        updateNeatoRobotScheduleDataReqParams.put(UpdateNeatoRobotScheduleData.Attribute.XML_DATA_VERSION,
                xml_data_version);
    ...
    public static GetRobotScheduleByTypeResult getScheduleBasedOnType(Context context, String robotSerialNumber,
            String scheduleType) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, GetScheduleBasedOnType.METHOD_NAME,
                requestParams);
        return AppUtils.checkResponseResult(response, GetRobotScheduleByTypeResult.class);
    }

    public static SetRobotProfileDetailsResult3 setEnableSchedule(Context context, String robotId, int scheduleType,
            boolean enableSchedule) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        return NeatoRobotDataWebservicesHelper.setRobotProfileDetailsRequest3(context, robotId,
                setEnableScheduleReqParams);
    }
