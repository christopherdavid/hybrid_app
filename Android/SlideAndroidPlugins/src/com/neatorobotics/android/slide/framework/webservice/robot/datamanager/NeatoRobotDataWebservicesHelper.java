...
public class NeatoRobotDataWebservicesHelper {
    ...
    public static SetRobotProfileDetailsResult3 setRobotProfileDetailsRequest3(Context context, String robotId,
        ...
        robotSetDetailParams.put(SetRobotProfileDetails3.Attribute.SOURCE_SMARTAPP_ID,
                NeatoPrefs.getUserEmailId(context));
        robotSetDetailParams.put(SetRobotProfileDetails3.Attribute.CAUSING_AGENT_ID,
                NeatoPrefs.getNeatoUserDeviceId(context));
        robotSetDetailParams.put(DeleteRobotProfileKey.Attribute.NOTIFICATION_FLAG,
                DeleteRobotProfileKey.DATA_CHANGED_NOTIFICATION_FLAG_ON);
    ...
    public static GetRobotProfileDetailsResult2 getRobotProfileDetailsRequest2(Context context, String robotId,
            String key) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, GetRobotProfileDetails2.METHOD_NAME,
                getRobotProfileParams);
    ...
    public static DeleteRobotProfileKeyResult deleteRobotProfileKey(Context context, String robotId, String key,
            boolean notify) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        robotDeleteKeyParams.put(DeleteRobotProfileKey.Attribute.CAUSING_AGENT_ID,
                NeatoPrefs.getNeatoUserDeviceId(context));
        if (notify) {
            robotDeleteKeyParams.put(DeleteRobotProfileKey.Attribute.NOTIFICATION_FLAG,
                    DeleteRobotProfileKey.DATA_CHANGED_NOTIFICATION_FLAG_ON);
        } else {
            robotDeleteKeyParams.put(DeleteRobotProfileKey.Attribute.NOTIFICATION_FLAG,
                    DeleteRobotProfileKey.DATA_CHANGED_NOTIFICATION_FLAG_OFF);
        }
        String response = MobileWebServiceClient.executeHttpPost(context, DeleteRobotProfileKey.METHOD_NAME,
                robotDeleteKeyParams);
        return AppUtils.checkResponseResult(response, DeleteRobotProfileKeyResult.class);
    }

    public static SetRobotProfileDetailsResult3 resetRobotProfileValue(Context context, String robotId, String... keys)
            throws UserUnauthorizedException, NeatoServerException, IOException {
