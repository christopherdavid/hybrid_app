...
- (id)initWithDispatchQueue:(dispatch_queue_t)queue
{
	if ((self = [super init]))
	{
        ...
        IsOnModuleQueue = &IsOnModuleQueue;
        
        void *nonNullUnusedPointer = (__bridge void *)self;
        dispatch_queue_set_specific(moduleQueue, IsOnModuleQueue, nonNullUnusedPointer, NULL);
	}
	return self;
}
...
- (BOOL)activate:(XMPPStream *)aXmppStream
{
	...
	if (dispatch_get_specific(IsOnModuleQueue))
		block();
	else
