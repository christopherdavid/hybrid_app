...
- (BOOL)authenticateAnonymously:(NSError **)errPtr
{
    ...
    void *IsOnXMPPQueue = &IsOnXMPPQueue;
    
    void *nonNullUnusedPointer = (__bridge void *)self;
    dispatch_queue_set_specific(self.xmppQueue, IsOnXMPPQueue, nonNullUnusedPointer, NULL);
    
    
	if (dispatch_get_specific(IsOnXMPPQueue))
		block();
	else
