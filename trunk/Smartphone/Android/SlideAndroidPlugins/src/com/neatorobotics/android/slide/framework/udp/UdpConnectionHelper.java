...
public class UdpConnectionHelper {
	...
	private class UdpServiceDiscoveryHelper
	{
		...
		private byte[] getRobotDiscoveryRequestPacket()
		{
			...
			try {
				dos.write(RobotDiscoveryPacketHeader.getHeader());
				byte [] discoveryPacket = discoveryCommand.getBytes();
				...
				public void run() {
					...
					while(true) {
						try {
							...
							String robotId = networkPacketBundle.getString(RobotCommandPacketConstants.KEY_ROBOT_ID);
							String robotIpAddress = networkPacketBundle.getString(RobotCommandPacketConstants.KEY_ROBOT_IP_ADDRESS);
							String robotSerialId = networkPacketBundle.getString(RobotCommandPacketConstants.KEY_ROBOT_SERIAL_ID);
							int robotPort = networkPacketBundle.getInt(RobotCommandPacketConstants.KEY_ROBOT_PORT);
							String robotName = networkPacketBundle.getString(RobotCommandPacketConstants.KEY_ROBOT_NAME);
