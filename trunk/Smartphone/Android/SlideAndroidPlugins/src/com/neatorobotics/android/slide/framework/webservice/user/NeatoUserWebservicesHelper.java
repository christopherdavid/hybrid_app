...
public class NeatoUserWebservicesHelper {
    ...
    public static LoginNeatoUserTokenResult loginNeatoUserToken(Context context, String email, String password)
        ...
        loginNeatoUserResult.put(LoginNeatoUser.Attribute.ACCOUNT_TYPE,
        ...
        String loginResponse = MobileWebServiceClient.executeHttpPost(context, LoginNeatoUser.METHOD_NAME,
                loginNeatoUserResult);
        LoginNeatoUserTokenResult loginResult = NeatoWebserviceUtils.readValueHelper(loginResponse,
                LoginNeatoUserTokenResult.class);

        // NOTE: AUTH_KEY value is NULL if validation_status is -2 in that case
        // we need to pass
    ...
    public static CreateNeatoUserResult createNeatoUser3RequestNative(Context context, String name, String email,
            String alternateEmail, String password, String userParams) throws UserUnauthorizedException,
            NeatoServerException, IOException {

        Map<String, String> createUser3ReqParams = new HashMap<String, String>();
        createUser3ReqParams.put(CreateNeatoUser3.Attribute.ACCOUNT_TYPE,
                NeatoUserWebServicesAttributes.ACCOUNT_TYPE_NATIVE);
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, CreateNeatoUser3.METHOD_NAME,
                createUser3ReqParams);
    ...
    public static IsUserValidatedResult isUserValidatedRequest(Context context, String email)
        ...
        String validateUserResponse = MobileWebServiceClient.executeHttpPost(context, IsUserValidated.METHOD_NAME,
                validateReqParams);
    ...
    public static ResendValidationMailResult resendValidationMailResult(Context context, String email)
        ...
        String resendValidationMailResponse = MobileWebServiceClient.executeHttpPost(context,
                ResendValidationMail.METHOD_NAME, resendValidationMailParams);
        return AppUtils.checkResponseResult(resendValidationMailResponse, ResendValidationMailResult.class);
    }

    public static RobotAssociationDisassociationResult associateNeatoRobotRequest(Context context, String email,
            String robotId) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        String associateRobotResponse = MobileWebServiceClient.executeHttpPost(context,
                AssociateNeatoRobotToUser.METHOD_NAME, associateRobotReqParams);
        return AppUtils.checkResponseResult(associateRobotResponse, RobotAssociationDisassociationResult.class);
    }

    public static RobotAssociationDisassociationResult disassociateNeatoRobotRequest(Context context, String email,
            String robotId) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        String dissociateResponse = MobileWebServiceClient.executeHttpPost(context,
                DisassociateNeatoRobotToUser.METHOD_NAME, associateRobotReqParams);
    ...
    public static RobotAssociationDisassociationResult dissociateAllNeatoRobotsRequest(Context context, String email)
        ...
        String dissociateResponse = MobileWebServiceClient.executeHttpPost(context,
                DissociateAllNeatoRobotsFromUser.METHOD_NAME, dissociateRobotReqParams);
        return AppUtils.checkResponseResult(dissociateResponse, RobotAssociationDisassociationResult.class);
    }
    ...
    public static GetUserAssociatedRobotsResult getUserAssociatedRobots(Context context, String email, String authToken)
        ...
        String associatedRobotsResponse = MobileWebServiceClient.executeHttpPost(context,
                GetUserAssociatedRobots.METHOD_NAME, reqParams);
        return AppUtils.checkResponseResult(associatedRobotsResponse, GetUserAssociatedRobotsResult.class);
    }

    public static SetUserAttributesResult setUserAttributeRequest(Context context, String authToken,
            HashMap<String, String> profileDetailsParams) throws UserUnauthorizedException, NeatoServerException,
            IOException {
        ...
        String associatedRobotsResponse = MobileWebServiceClient.executeHttpPost(context,
                SetUserAttributes.METHOD_NAME, userSetAttributesParams);
        return AppUtils.checkResponseResult(associatedRobotsResponse, SetUserAttributesResult.class);
    }

    public static SetUserAccountDetailsResult setUserAccountDetailsRequest(Context context, String email,
            String authToken, HashMap<String, String> profileDetailsParams) throws UserUnauthorizedException,
            NeatoServerException, IOException {
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, SetUserAccountDetails.METHOD_NAME,
                userSetAccountDetailsParams);
    ...
    public static ForgetPasswordResult forgetPasswordRequest(Context context, String email)
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, ForgetPassword.METHOD_NAME,
                changePasswordParams);
        return AppUtils.checkResponseResult(response, ForgetPasswordResult.class);
    }

    public static RegisterPushNotificationResult registerPushNotification(Context context, String email,
            int deviceType, String registrationId) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        registerPushNotificationParams.put(RegisterPushNotifications.Attribute.DEVICE_TYPE,
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, RegisterPushNotifications.METHOD_NAME,
                registerPushNotificationParams);
    ...
    public static UnregisterPushNotificationResult unregisterPushNotification(Context context, String registrationId)
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, UnregisterPushNotifications.METHOD_NAME,
                unregisterPushNotificationParams);
        return AppUtils.checkResponseResult(response, UnregisterPushNotificationResult.class);
    }

    public static ChangePasswordResult changePasswordRequest(Context context, String authToken, String oldPassword,
            String newPassword) throws UserUnauthorizedException, NeatoServerException, IOException {
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, ChangePassword.METHOD_NAME,
                changePasswordParams);
    ...
    public static RobotLinkResult initiateLinkToRobot(Context context, String emailId, String linkCode)
        ...
        String response = MobileWebServiceClient.executeHttpPost(context, InitiateLinkToRobot.METHOD_NAME,
                initiateLinkParams);
