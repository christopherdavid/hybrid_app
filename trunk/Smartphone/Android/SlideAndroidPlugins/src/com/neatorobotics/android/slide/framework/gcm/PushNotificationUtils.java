...
public class PushNotificationUtils {
    ...
    // Public helper method to register with Google Push notification service
    // GCM
    public static void registerForPushNotification(Context context) {
        ...
        // checkManifest - checks if the application manifest meets all
        // requirements
        // NOTE: only required while developing, can be removed when app is
        // ready to
        // be published
        GCMRegistrar.checkManifest(context);
        LogHelper.logD(TAG, "checkManifest succeeded");

        // GCMRegistrar keeps track of registration IDs. Before registering we
        // should
        // check if the device is already registered by getting the registration
        // id
