...
public class RobotCommandPacket {
	...
	public static RobotCommandPacket createRobotCommandPacket(RobotCommandPacketHeader header, RobotRequests robotCommands)
	{
		RobotCommandPacket robotCommandPacket = new RobotCommandPacket(header, robotCommands);
		return robotCommandPacket;
	}
	
	public static RobotCommandPacket createRobotCommandPacket(RobotCommandPacketHeader header, RequestPacket robotCommand)
	{
	...
	public static RobotCommandPacket createRobotPacketWithResponseData(RobotCommandPacketHeader header, ResponsePacket commandResonse)
	{
