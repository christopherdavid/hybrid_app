...
public class NeatoWebServerType extends WebServerType {
    ...
    final String NEATOSTAGING_BASE_JSON_URL = "https://staging-smartapp.neatorobotics.com/api/rest/json";
    ...
    final String NEATOSTAGING_SERVER_URL = "https://staging-smartapp.neatorobotics.com";
    final String NEATOSTAGING_XMPP_WEBSERVER = "staging-smartapp.neatorobotics.com";
    ...
    final String NEATO_SECURE_XMPP_WEBSERVER = "rajatogo";
    ...
    public String getXmppWebServer() {
        ...
        switch (getCurrentServerCode()) {
            ...
            case NeatoWebConstants.NEATOSTAGING_SERVER_ID:
                return NEATOSTAGING_XMPP_WEBSERVER;
            case NeatoWebConstants.DEV_SERVER_ID:
            ...
            case NeatoWebConstants.NEATO_SECURE_SERVER_ID:
                return NEATO_SECURE_XMPP_WEBSERVER;
        }
        return PROD_XMPP_SERVER_DOMAIN;
    }
