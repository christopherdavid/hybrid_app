...
public class SettingsManager {
	...
	public void getNotificationSettings(final String email, final WebServiceBaseRequestListener listener) {
		...
		Runnable task = new Runnable() {
			public void run() {
				try {
					RobotNotificationSettingsResult settingsResult =  NeatoRobotWebservicesSettingsHelper.getRobotNotificationSettingsRequest(mContext, email);
					RobotHelper.saveNotificationSettingsJson(mContext, email, settingsResult.getNotificationsJson().toString());
	...
	public void updateNotificationState(final String email, final String notificationId, 
			final boolean enable, final WebServiceBaseRequestListener listener) {
		...
		Runnable task = new Runnable() {
			public void run() {
				try {
					...
					NeatoWebserviceResult result = NeatoRobotWebservicesSettingsHelper.setRobotNotificationSettingsRequest(mContext, email, updatedJsonObj.toString());
