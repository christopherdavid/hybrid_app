...
public class ErrorTypes {
	...
	public static final int JSON_PARSING_ERROR = 1004;
	public static final int INVALID_SCHEDULE_ID = 1005;
	public static final int INVALID_EVENT_ID	= 1006;
	public static final int NO_SCHEDULE_FOR_ROBOT = 1007;
